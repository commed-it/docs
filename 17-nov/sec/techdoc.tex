...
\subsubsection{Wireframe}
In this section we are going to show the paper wireframe thath we drawed with the first ideas that we had for the dessign of the web application.
\begin{figure}[H]
  \centering
...
\subsubsection{Application}
In this section we are going to show all the Screens that actually our application contains.
\begin{figure}[H]
  \centering
